...
public class ControlsButton : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (IsOverlapComplete())
        {
            ...
            MenuManager.Instance.UpdateMenuState(MenuManager.MenuState.Controls);
    ...
    void DisplayColors()
    {
        ...
        controls.transform.position = Vector3.Lerp(land.transform.position, new Vector3(land.GetCenterPosition().x - 85f, 10f, 15f), 0.1f);
    }
